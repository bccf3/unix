...
void	err_dump(const char *, ...) __attribute__((noreturn));  // 系统调用相关， dump core and terminate
void	err_quit(const char *, ...) __attribute__((noreturn));
void	err_cont(int, const char *, ...);
void	err_exit(int, const char *, ...) __attribute__((noreturn)); 
void	err_ret(const char *, ...);  // 系统调用相关，
void	err_sys(const char *, ...) __attribute__((noreturn)); // 系统调用相关， 出错则退出程序
